...
export const TRANSLATIONS = {
  [Language.EN]: {
    ...
    prefNotifications: 'Notification Center',
    ...
    prefSMSUpdatesDesc: 'Receive SMS when a loan status changes (e.g. Marked as Paid).',
    prefEmailUpdates: 'Email Status Updates',
    prefEmailUpdatesDesc: 'Receive Email alerts for real-time status updates.',
  ...
  [Language.XH]: {
    ...
    prefNotifications: 'Uvimba wezaziso',
    ...
    prefSMSUpdates: 'Izaziso ze-SMS zenkqubo',
    prefSMSUpdatesDesc: 'Fumana i-SMS xa imeko yemali itshintsha.',
    prefEmailUpdates: 'Izaziso ze-Email zenkqubo',
    prefEmailUpdatesDesc: 'Fumana i-email xa kukho utshintsho emalini.',
